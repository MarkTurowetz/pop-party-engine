...
function defaultControllerComposition(id, name, description, canvas, components, timeline = null) {
    return {
        id,
        name,
        surface: "controller",
...
function stageBackgroundShape(id, name, width, height, options = {}) {
    return {
        id,
        name,
        instanceLabel: id.replace(/-([a-z])/g, (_, letter) => letter.toUpperCase()),
...
function stageBackgroundComposition(id, name, description, canvas, components, timeline = null, compositionKind = "prefab") {
    return {
        id,
        name,
        description,
...
function defaultStageBackgroundCompositions() {
    ...
    return [
        stageBackgroundComposition("stage-background-gradient-plane", "Background Gradient Plane", "Base gradient plane for the default stage background.", { width: 1920, height: 1080 }, [stageBackgroundShape("gradient-plane", "Gradient Plane", 1920, 1080, {
                fillCss: "linear-gradient(135deg, #24115f 0%, #5b1bbd 46%, #ff4fa3 100%)"
            })]),
        stageBackgroundComposition("stage-background-orb-yellow", "Background Yellow Orb", "Top-left translucent yellow background orb.", { width: 256, height: 256 }, [stageBackgroundShape("yellow-orb", "Yellow Orb", 256, 256, {
                shapeStyle: "circle",
                fillColor: "#ffe156f2"
            })]),
        stageBackgroundComposition("stage-background-orb-cyan", "Background Cyan Orb", "Top-right translucent cyan background orb.", { width: 256, height: 256 }, [stageBackgroundShape("cyan-orb", "Cyan Orb", 256, 256, {
                shapeStyle: "circle",
                fillColor: "#22d3eec7"
            })]),
        stageBackgroundComposition("stage-background-orb-pink", "Background Pink Orb", "Bottom-right translucent pink background orb.", { width: 320, height: 320 }, [stageBackgroundShape("pink-orb", "Pink Orb", 320, 320, {
                shapeStyle: "circle",
                fillColor: "#ff4fa3ad"
            })]),
        stageBackgroundComposition("stage-background-fan-left-art", "Background Left Fan Art", "Editable repeating-conic fan artwork for the lower-left background.", { width: fanLeftSize, height: fanLeftSize }, [stageBackgroundShape("fan-art", "Left Fan", fanLeftSize, fanLeftSize, {
                shapeStyle: "circle",
                fillCss: "repeating-conic-gradient(from 9deg, rgba(255, 255, 255, 0.24) 0deg 10deg, transparent 10deg 22deg)"
            })]),
        stageBackgroundComposition("stage-background-fan-right-art", "Background Right Fan Art", "Editable repeating-conic fan artwork for the upper-right background.", { width: fanRightSize, height: fanRightSize }, [stageBackgroundShape("fan-art", "Right Fan", fanRightSize, fanRightSize, {
                shapeStyle: "circle",
                fillCss: "repeating-conic-gradient(from 0deg, rgba(255, 255, 255, 0.24) 0deg 8deg, transparent 8deg 18deg)"
            })]),
        stageBackgroundComposition("stage-background-fan-left-mc", "Background Left Fan MC", "Lifecycle wrapper whose Idle animation rotates the lower-left fan clockwise.", { width: fanLeftSize, height: fanLeftSize }, [stageBackgroundReference("fan-art", "Left Fan Art", "stage-background-fan-left-art", fanLeftSize / 2, fanLeftSize / 2)], stageBackgroundFanTimeline("fan-art", 1320, "clockwise")),
        stageBackgroundComposition("stage-background-fan-right-mc", "Background Right Fan MC", "Lifecycle wrapper whose Idle animation rotates the upper-right fan counterclockwise.", { width: fanRightSize, height: fanRightSize }, [stageBackgroundReference("fan-art", "Right Fan Art", "stage-background-fan-right-art", fanRightSize / 2, fanRightSize / 2)], stageBackgroundFanTimeline("fan-art", 1080, "counterclockwise")),
        stageBackgroundComposition("stage-background-default", "Default Stage Background", "Compound default background scene with independently animated fan children.", { width: 1920, height: 1080 }, [
        ...
        stageBackgroundComposition("stage-background", "Stage Background", "Top-level background selector. Each labeled frame can activate a different nested background scene.", { width: 1920, height: 1080 }, [stageBackgroundReference("background-default", "Default Background", "stage-background-default", 960, 540)], stageBackgroundSelectorTimeline(), "gameObject")
    ];
}
const defaultArtCompositions = [
    ...
    defaultControllerComposition("controller-player-banner", "Controller Player Banner", "Compound controller player banner with independent avatar and player-name children.", { width: 338, height: 78 }, [
