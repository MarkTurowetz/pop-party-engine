...
const GAME_FLOW_GITHUB_REPO = process.env.GAME_FLOW_GITHUB_REPO || process.env.GITHUB_REPOSITORY || "MarkTurowetz/pop-party-engine";
...
const ART_MANIFEST_FILE = path.join(__dirname, "authoring", "art-manifest.json");
