...
function generateGame(options = {}) {
  ...
  try {
    ...
    writeText(stagingRoot, "src/inputs/index.js", generatedContributionSource("controller input"));
    writeText(stagingRoot, "src/controller-interactions/index.js", generatedContributionSource("persistent authenticated controller interaction"));
