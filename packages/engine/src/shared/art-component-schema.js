...
(function () {
    ...
    function normalizeSpriteRenderMode(value) {
    ...
    function validateImageFile(file) {
        ...
        if (Number(file.size || 0) <= 0 || Number(file.size || 0) > componentImageMaxBytes)
            return "Sprite images must be under 5 MB.";
        return "";
    }
