...
(function () {
    ...
    function layoutTextFieldLifecycleTimeline() {
        return {
            fps: 30,
            frameCount: 33,
            labels: [
    ...
    function defaultLayoutTextFieldCompositions() {
        return [
            {
    ...
    function layoutTextFieldReferenceComponent() {
        return {
    ...
    function migrateLayoutTextFieldWidgetComponents(compositionId, components = []) {
        ...
        if (compositionId === layoutTextArtTextPrefabId) {
            ...
            if (text)
                text.instanceLabel = text.instanceLabel || layoutTextArtComponentId;
        }
        return components;
    }
    function migrateLayoutTextFieldWidgetTimeline(compositionId, timeline, fallbackTimeline) {
        if (compositionId !== layoutTextArtCompositionId)
            return timeline;
