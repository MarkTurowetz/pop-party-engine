...
const initialHostAudios: HostAudios = {
  hostAudios: [
    { id: "intro", name: "Intro", lines: [{ id: "line-1", text: "Welcome", url: "/intro.mp3" }] },
    {
      id: "scoring",
      name: "Scoring",
      lines: [{ id: "line-2", text: "Points", url: "/scoring.mp3" }]
    }
  ]
};
...
describe("HostAudioEditor", () => {
  it("uses the shared sidebar shell and renders one selected set in the preview pane", () => {
    ...
    const markup = renderToStaticMarkup(
      <HostAudioEditor controller={controller} surface="tools" />
    );
    ...
    expect(markup).toContain('data-play-host-audio-line="0:0"');
    expect(markup).not.toContain("data-remove-host-audio-line");
