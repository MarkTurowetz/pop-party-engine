...
function baseLayoutObjectCatalog() {
  ...
  const legacyStageObjects = [
    ...
    { id: "joinPrompt", name: "Join Prompt", selector: "#joinPrompt", kind: "art", artCompositionId: "join-widget", width: 740, height: 76 },
    { id: "startPopup", name: "Countdown Popup", selector: "#startPopup", kind: "art", artCompositionId: "countdown-popup", width: 700, height: 130 },
    { id: "craftingTimer", name: "Crafting Timer", selector: "#craftingTimer", kind: "art", artCompositionId: "crafting-timer-widget", width: 180, height: 180 },
    { id: "stageCodeBadge", name: "Small Room Code Widget", selector: "#stageCodeBadge", kind: "art", artCompositionId: "stage-code-widget", width: 170, height: 82 },
...
function updateLayoutPreviewTextStyle(element) {
  ...
  if (textNode) {
    const hasRenderedFitText = Boolean(textNode.querySelector(":scope > .text-fit-lines, :scope > .text-fit-svg"));
