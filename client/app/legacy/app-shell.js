...
const controllerIntroMessage = "controllerIntroMessage";
const controllerGlobalActionState = document.querySelector("#controllerGlobalActionState");
const controllerGlobalActionMessage = "controllerGlobalActionMessage";
...
window.craftingTimerLabel = craftingTimerLabel;
...
window.controllerIntroState = controllerIntroState;
window.controllerIntroMessage = controllerIntroMessage;
window.controllerGlobalActionState = controllerGlobalActionState;
window.controllerGlobalActionMessage = controllerGlobalActionMessage;
window.controllerGlobalActionButton = controllerGlobalActionButton;
...
window.controllerMicAccessButton = controllerMicAccessButton;
...
window.controllerTextSubmitButton = controllerTextSubmitButton;
window.controllerVoiceButton = controllerVoiceButton;
...
window.controllerPlayerBannerAvatar = controllerPlayerBannerAvatar;
window.controllerPlayerBannerName = controllerPlayerBannerName;
window.controllerMeta = controllerMeta;
window.startGameButton = startGameButton;
window.introPresentButton = introPresentButton;
