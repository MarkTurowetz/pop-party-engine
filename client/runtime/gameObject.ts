...
class GameObject {
  ...
  createVisual(): VisualInstance | null {
    ...
    this.visual = PartyGameVisualObject.createCssVisualObject({
      ...
      exitingClass: options.exitingClass === "" ? "" : (options.exitingClass as string) || "stage-layout-visual-exiting",
      updateClass: options.updateClass === "" ? "" : (options.updateClass as string) || "stage-layout-visual-update",
