...
if (!/element\.autoFitText === true/.test(engineLayoutNormalizerSource)
...
const artNormalizerSource = fs.readFileSync(
  path.join(repoRoot, "packages/engine/src/server/art-component-normalization-runtime.js"),
  "utf8"
);
