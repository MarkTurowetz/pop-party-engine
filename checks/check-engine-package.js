...
try {
  ...
  for (const exportName of ["createActionCompletionBarrier", "createControllerModuleCache", "createControllerSessionRuntime", "createControllerSubmitApi", "createControllerViewState", "controllerViewVisitKey", "distributedContainerItemPositions", "effectiveVisibilityTimeline", "resolveControllerSubmissionConfirmation"]) {
  ...
  fs.writeFileSync(path.join(fixtureRoot, "consumer.ts"), [
    ...
    'import { controllerViewVisitKey, createActionCompletionBarrier, createApiClient, createControllerModuleCache, createControllerSessionRuntime, createControllerSubmitApi, createControllerViewState, distributedContainerItemPositions, effectiveVisibilityTimeline, resolveControllerSubmissionConfirmation } from "@pop-party/engine/client";',
