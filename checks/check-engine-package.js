...
try {
  ...
  fs.writeFileSync(path.join(fixtureRoot, "consumer.ts"), [
    ...
    'import { createInputStateRuntime, createLayoutNormalizationRuntime, createStageLayoutNormalizationRuntime } from "@pop-party/engine/server";',
